...
import com.valkryst.BunnyEmu.entities.packet.IPacketReadable;
import com.valkryst.BunnyEmu.entities.packet.IPacketWritable;
...
import com.valkryst.BunnyEmu.logon.RealmAuth;
...
import com.valkryst.BunnyEmu.utils.PacketLog;
import com.valkryst.BunnyEmu.utils.PacketLog.PacketType;
        ...
        try{
            ...
            while((readByte = (byte) in.read()) != -1){
                ...
                try {
                	...
                	ClientPacket pTemp = (ClientPacket) Class.forName("com.valkryst.BunnyEmu.net.packets.client." + p.sOpcode).newInstance();
                	pTemp.put(p);
                	p = pTemp;
					try {
